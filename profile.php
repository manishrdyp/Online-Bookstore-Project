              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                   ...
                   { 
                    echo '<img src="header/avatar.jpg" alt="Admin" class="rounded-circle" width="150">';
                   }
                   else
                   {
                      ...
                      ?>
                          <img src="image/<?php echo $data['filename']; ?>" class="rounded-circle" width="150" >
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">https://User.com</span>
                  </li>
              ...
              <div class="row gutters-sm">
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2"></i>User Status</h6>
                      <small>Acheivements</small>
                      <div class="progress mb-3" style="height: 5px">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                      <small>Books Reading</small>
                      <div class="progress mb-3" style="height: 5px">
                      ...
                      <div class="progress mb-3" style="height: 5px">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: 72%" aria-valuenow="89" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                      <small>Books Purchased</small>
                      <div class="progress mb-3" style="height: 5px">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: 55%" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                      <small>Books Rented</small>
                      <div class="progress mb-3" style="height: 5px">
